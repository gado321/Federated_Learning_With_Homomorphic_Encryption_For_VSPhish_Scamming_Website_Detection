...
def server_program():
   ...
   agentsIP = ['192.168.1.1', '192.168.1.2', '192.168.1.3']
   ...
   for round in range(rounds):
       ...
       while (time.time() - start_t) < 180: # round time = local training time + file sending time + epsilon
       ...
       with open('aggregated_weights.pkl', 'wb') as file:
